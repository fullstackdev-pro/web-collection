  ...
  return (
    <div className={"px-20 py-10 bg-blue-900"}>
      ...
      <div className="overflow-x-auto relative dark:bg-gray-900  shadow-md sm:rounded-lg">
        ...
        <nav
          className="flex justify-center items-center pt-4  px-4 py-4"
        ...
        >
          <ul className="inline-flex items-center -space-x-px">
            ...
            {pages.map((pageIndex) => (
              <li>
                <button
                  disabled={page === pageIndex + 1 ? true : false}
                  onClick={() => setPage(pageIndex + 1)}
                  className={`${
                    page === pageIndex + 1 ? "disabled:opacity-25" : ""
            ...
            <li>
              <button
                onClick={next}
                disabled={page === UserReducer.usersTotal ? true : false}
                className={`${
                  page === UserReducer.usersTotal ? "disabled:opacity-25" : ""
