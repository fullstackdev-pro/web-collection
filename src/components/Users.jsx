...
function Users({getusers,UserReducer}) {
        ...
        <div className={'px-20 py-10 bg-blue-900'}>
           <h2 className={'text-center p-4 text-white text-4xl'}>Users</h2>
            <div className="overflow-x-auto relative dark:bg-gray-900  shadow-md sm:rounded-lg">
                <div className="pb-4 px-4 py-4 bg-white dark:bg-gray-900 ">
                    ...
                    <tbody>
                    {
                        UserReducer.users.map(item=>
                            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td className="py-4 px-6">
                                    <a href="#"
                                       className="font-medium mr-4 text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                ...
                <nav className="flex justify-between items-center pt-4  px-4 py-4" aria-label="Table navigation">
...
export default connect(UserReducer,{getusers}) (Users);
