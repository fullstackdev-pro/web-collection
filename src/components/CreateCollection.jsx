...
function CreateCollection(props) {
    ...
    return (
        <div className={'p-10 bg-blue-900'}>
            <p className="text-4xl font-medium text-center text-gray-900 dark:text-white">Create new Collection</p>
            <form className={'px-40'}>
                <div className="mb-6">
                    <label htmlFor="title" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Title
                        </label>
